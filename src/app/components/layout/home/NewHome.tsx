  ...
  return (
    ...
    <div className="w-7/12 grid p-5 mx-10 border bg-gray-50 border-gray-500 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-1">
        ...
        <div className="grid mb-8 border border-none rounded-lg gap-2 shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
            ...
            <figure className="flex w-auto flex-col items-end justify-center p-5 text-start bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
