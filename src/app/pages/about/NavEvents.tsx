...
import video from '../../assets/img/gt-video.svg';
import lauchpadxx from '../../assets/img/gt-video1.svg';
...
function NavEvents() {
  ...
  return (
    <div>
        <div className="flex flex-col bg-tramsparent my-5"> 
        <h1>Voting</h1>
        <div>

          <div className="flex flex-col my-5 bg-[#F7F8F9]">
            <h2>OPTION 1</h2>
            <div className="h-auto relative z-0 flex bg-gray-500">
              <div className="text-4xl">
                {/* The main content of the file and it has it's content all over the page
                and i want to build a navbar on top of this */}
                <svg width="715" height="10" viewBox="0 0 715 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="715" height="10" rx="4" fill="#D9D9D9"/>
                  </svg>
              </div>
              <div className="absolute inset-y-0 left-0 z-10 bg-green-400 w-1/2">
                <div className="flex h-full items-center justify-center text-4xl">
                  {/* Mobile Navbar */}
                  <svg width="358" height="10" viewBox="0 0 358 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="357.5" height="10" rx="4" fill="#0F9D58"/>
                  </svg>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#F7F8F9]">
            ...
            <div className="h-auto relative z-0 flex bg-gray-500">
              ...
              <div className="absolute inset-y-0 left-0 z-10 bg-green-400 w-1/3">
                <div className="flex h-full items-center justify-center text-4xl">
                  {/* Mobile Navbar */}
                  <svg width="246" height="10" viewBox="0 0 246 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="245.06" height="10" rx="4" fill="#0F9D58"/>
                  </svg>
        ...
        <div className="lg:max-auto w-auto my-5">
                <h1>Upcoming Live</h1>

                <div className="flex w-full justify-between items-center bg-[#F7F8F9] px-5">
                  ...
                  <button className="text-[#0F9D58]">Add reminder</button>
                </div>
        </div>

        <div className="lg:max-w-auto w-auto my-2">
                {/* <h1>Upcoming Live</h1> */}

                <div className="flex justify-between items-center bg-[#F7F8F9] px-5">
    ...
    <div className="lg:max-w-xl w-full my-5">
        ...
        <div className="flex gap-2 my-5">
            ...
            <div className="flex flex-col">
                ...
                <time>11:09 AM . Oct 19, 2023</time>
              </div>
          </div>

          <div className="mx-8">
          <p>AMA- Introduction of our idea on creating a decentralized freelancing network.</p>   
