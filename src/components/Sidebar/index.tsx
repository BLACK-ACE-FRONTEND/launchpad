...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 pt-1 px-0 py-5.5 lg:py-6.5">
        <Link href="/">
           {/* <Image
            width={176}
            height={32}
      ...
      <button
        ...
        className=  {`group relative flex bg-[#0F9D58] text-white items-center gap-2.5 rounded-sm py-2 px-4 font-medium 
